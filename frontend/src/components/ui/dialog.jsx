...
const DialogTitle = forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return <DialogPrimitive.Title ref={ref} className={cn('text-lg font-semibold', className)} {...rest} />;
});
DialogTitle.displayName = 'DialogTitle';

const DialogDescription = forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return <DialogPrimitive.Description ref={ref} className={cn('text-sm text-gray-600', className)} {...rest} />;
});
